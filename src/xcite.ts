...
export const xcite_get = (p_name: string) => s_templates[p_name];
export const xcite_run = (p_name: string, p_data?: any) => xcite_get(p_name)(p_data);

export function xcite_template(p_template: string, p_name?: string) {
	...
	const v_f = (p_data?: any) => v_f0(p_data, xcite_run);
